...
def win1():
    ...
    def read_through_text():
        ...
        # Adding Widgets....................
        label2 = Label(root,text="Type the text below :",font=("Lucida Handwriting",18),background=mainbg,fg=label_colour)
    ...
    label1 = Label(root,text="Choose one of the option :",font=("Lucida Handwriting",18),background=mainbg,fg=label_colour)
    ...
    def sett1():
        ...
        label3_2 = Label(root1,text="Choose the Voice you want :",font=("Lucida Handwriting",12))
        ...
        label4_1 = Label(root1,text="Select the rate : ",font=("Lucida Handwriting",12))
        ...
        def homewarn():
            label5_1 = Label(root1,text="(Please, Return to home to update latest theme)",font=("Lucida Handwriting",10),fg='red')
        ...
        the1 = Button(root1,text='Gold Black',width=12,height=4,command=theme1)
...
labelstart=Label(root,text='Welcome to Harmony',font=('Freestyle Script',22),fg='crimson',bg=mainbg)
labelstart.grid(row=1,column=1,padx=130)
labelstart1=Label(root,text='Podcast Engine',font=('Lucida Handwriting',34),fg='crimson',bg=mainbg)
...
def crie():
    ...
    label_head = Label(cre,text='Credits',font=("Bookman Old Style", 50, BOLD),anchor=CENTER,fg='dark green',bg=backg)
    label_head.pack()


    label_name1= Label(cre,text='Vikram Chourasiya',font=("Lucida Handwriting",32,BOLD),fg='dark green',bg=backg)
    label_name1.pack()
